...
public class TinyDB {
    ...
    public ArrayList<basicReminder> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<basicReminder> objects =  new ArrayList<basicReminder>();

    	for(String jObjString : objStrings){
    		Object value  = gson.fromJson(jObjString,  mClass);
    		objects.add((basicReminder) value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<basicReminder> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
